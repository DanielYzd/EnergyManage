<template>
    <div v-if="visible" @close="stopProg">
        <el-card id="dialog" class="box-card">
            <div slot="header" class="clearfix">
                ...
                <span style="text-align:center;">
                    <el-button type="success" @click="reSend" :disabled="callStatus.loading" size="mini">重发</el-button>
                    <el-button type="warning" @click="stopProg" :disabled="!callStatus.loading" size="mini">停止
                    </el-button>
                </span>
            </div>
            <el-row :gutter="20">
                <el-col :span="24">
                    <el-table :data="commResult" style="width: 100%" size="mini">
                        <el-table-column prop="rtuAddr" label="终端地址" min-width="90"></el-table-column>
                        <el-table-column prop="successDesc" label="结果" min-width="160"></el-table-column>
                        <!--<el-table-column prop="taskid" label="taskid" min-width="160"></el-table-column>-->
                        <el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
                            <template slot-scope="scope">
                                <el-button type="text" size="small" v-if="!callStatus.loading"
                                    @click="reTryHandle(scope.row)">重试</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-col>
            ...
            <el-row :gutter="20">
                <el-col :span="24" style="text-align:center;margin-top:6px;margin-bottom:6px;">
                    <el-progress :percentage="callStatus.percentage"></el-progress>
                </el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="24" style="text-align:center;">
                    <el-input type="textarea" v-bind:style="{ height: winStyle.textAreaHeight + 'px' }" :rows="7"
                        placeholder="报文" v-model="msg"></el-input>
                </el-col>
            </el-row>
        </el-card>
    </div>
