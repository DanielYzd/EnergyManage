...
<template>
	<div>
		<el-form ref="form" :inline="true" :model="dataForm" @keyup.enter.native="getDataList()" size="small" label-width="90px">
		    ...
		    <el-form-item style="float: right;">
				...
				<el-button @click="changeOptHandler()" type="warning">换表</el-button>
		    </el-form-item>
		</el-form>
