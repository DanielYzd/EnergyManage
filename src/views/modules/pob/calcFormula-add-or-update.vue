  ...
  >
    ...
    <el-tabs style="margin-left: 40px;">
      <el-tab-pane label="累加“+”表计">
        ...
        <el-form-item>
          <el-button
            @click="getDataList('addMeter')"
            type="primary"
          >查询</el-button>
          <el-button
            @click="selectedAll('addMeter')"
            type="primary"
          >全选</el-button>
          <el-button
            @click="clearAll('addPointids')"
            type="primary"
          >清空</el-button>
        </el-form-item>
        <br>
        <el-row :gutter="20">
          <el-col :span="11">
            <hltable
              ...
              height="150"
              @selections="(data)=>{this.addMeterWaitList = data}"
            ></hltable>
          </el-col>
          <el-col :span="2">
      ...
      <el-tab-pane label="累加“+”公式">
        ...
        <el-form-item>
          ...
          >查询</el-button>
          <el-button
            @click="selectedAll('addFormula')"
            type="primary"
          >全选</el-button>
          <el-button
            @click="clearAll('addFormulaids')"
            type="primary"
          >清空</el-button>
        </el-form-item>
        <br>
      ...
      <el-tab-pane label="累减“-”表计">
        ...
        <el-form-item>
          <el-button
            @click="getDataList('subMeter')"
            type="primary"
          >查询</el-button>
          <el-button
            @click="selectedAll('subMeter')"
            type="primary"
          >全选</el-button>
          <el-button
            @click="clearAll('subMeter')"
            type="primary"
          >清空</el-button>
        </el-form-item>
        ...
        <el-row :gutter="20">
          <el-col :span="11">
            <hltable
              ...
              height="150"
              @selections="(data)=>{this.subMeterWaitList = data}"
            ></hltable>
          </el-col>
          <el-col :span="2">
            <div class="el-transfer__buttons">
      ...
      <el-tab-pane label="累减“-”公式">
        ...
        <el-form-item>
          ...
          >查询</el-button>
          <el-button
            @click="selectedAll('subFormula')"
            type="primary"
          >全选</el-button>
          <el-button
            @click="clearAll('subFormulaids')"
            type="primary"
          >清空</el-button>
        </el-form-item>
        <br>
