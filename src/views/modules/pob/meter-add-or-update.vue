<template>
  ...
  >
    ...
    >
      ...
      <el-form-item
        label="计量区域（入住房间）"
        v-if="dataForm.type < 4 && (dataForm.loopUsedType == 1110 || dataForm.loopUsedType == 1111)"
      >
        <el-select
      ...
      <!--<el-form-item label="总表" prop="ctid" v-if="dataForm.eleType > 0">
		        <el-select v-model="dataForm.parentId" placeholder="总表"  style="width:220px">
				      <el-option v-for="item in parentIdList" :key="item.pointid" :label="item.disc" :value="item.pointid"></el-option>
				    </el-select>
	  		</el-form-item>-->
      <br>
