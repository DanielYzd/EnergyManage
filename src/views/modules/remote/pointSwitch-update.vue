  ...
  <el-dialog custom-class="dialogcommon" title="下发" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" :inline="true" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="表序号" prop="numberid">
        <el-input-number v-model="dataForm.numberid" disabled :min="1" :max="1000" label="请输入表序号" style="width: 200px;">
        </el-input-number>
      </el-form-item>
      <el-form-item label="表通信地址" prop="commaddress">
        <el-input v-model="dataForm.commaddress" disabled placeholder="表通信地址" clearable style="width: 200px;">
        </el-input>
      </el-form-item>
