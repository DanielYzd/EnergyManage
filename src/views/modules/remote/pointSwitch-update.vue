  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :inline="true" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="180px" size="small">
      	...
      	<el-form-item label="终端地址" prop="rtuid">
      			<el-input v-model="dataForm.rtuAddr" disabled style="width: 200px;"></el-input>
      	</el-form-item>
				<el-form-item label="表序号" prop="numberid">
	        	<el-input-number v-model="dataForm.numberid" disabled :min="1" :max="1000" label="请输入表序号" style="width: 200px;"></el-input-number>
				</el-form-item>
				<el-form-item label="表通信地址" prop="commaddress">
	    		<el-input v-model="dataForm.commaddress" disabled placeholder="表通信地址" clearable style="width: 200px;"></el-input>
	  		</el-form-item>
...
export default {
  ...
  data () {
    return {
      ...
      energyTypeList: [],
      portTypeList: [{'value': 1, 'key': 'COM1'}, {'value': 2, 'key': '485端口1'}, {'value': 3, 'key': '485端口2'}, {'value': 31, 'key': '载波'}],
      commRateList: [{'value': 0, 'key': '默认速率'}, {'value': 1, 'key': '600'}, {'value': 2, 'key': '1200'}, {'value': 3, 'key': '2400'}, {'value': 4, 'key': '4800'}, {'value': 5, 'key': '7200'}, {'value': 6, 'key': '9600'}, {'value': 7, 'key': '19200'}],
      protocolList: [{'value': 1, 'key': 'DL/T 645—1997'}, {'value': 30, 'key': 'DL/T 645—2007'}, {'value': 32, 'key': '水气热表CJ/T 188-2004'}, {'value': 2, 'key': '交流采样装置通信协议'}], //
      dataRule: {
        commaddress: [
      ...
      if (this.dataForm.pointid) {
        this.$http({
          ...
          if (data && data.code === 0) {
            ...
            if (data.point.rtuid) {
                	var tmp = { rtuid: data.point.rtuid, commaddress: data.point.rtuAddr}
                	if (this.rtuList.findIndex(function (item) {
