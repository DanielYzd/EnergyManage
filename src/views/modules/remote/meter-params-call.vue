<template>
	<el-dialog custom-class="dialogcommon" :title="this.flag === 0 ? '召读指定表序号' : '清除表地址'" :close-on-click-modal="false"
		...
		<el-form :model="dataForm" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="140px"
			...
			<el-form-item label="表序号" prop="numberid">
				<el-input-number v-model="dataForm.numberid" require :min="1" :max="1000" label="请输入表序号">
				</el-input-number>
			</el-form-item>
