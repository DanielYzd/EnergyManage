...
<template>
  <div>
    <div style="">
      <el-card class="box-card" style="width: 100%;min-width: 200px;">
        <el-form
          ref="form"
          :model="dataForm"
          label-width="95px"
          ...
          <template v-if="queryType === 0">
            ...
            <el-form-item label="所有表计">
              <el-radio-group v-model="dataForm.selectedPointid">
                <el-radio
                  @change="pointChange(meter.pointid, meter.type)"
                  style="display: inline-flex;margin-top: 10px;margin-left: 30px;"
...
export default {
  data() {
    return {
      ...
      dataForm: {
        ...
        schemeid: 2,
        datatime: [
          tool.formatDate(tool.addDay(new Date(), -7), 'yyyy-MM-dd'),
  ...
  methods: {
    init() {
      var height =
        this.documentClientHeight - this.$refs.form.$el.offsetHeight - 160 - 50
      ...
      if (params.datatime) {
        ...
        this.dataForm.datatime = [
          tool.formatDate(tool.addDay(tmpDate, -15), 'yyyy-MM-dd 00:00:00'),
      ...
      this.$http.ajaxGet(
        ...
        res => {
          ...
          if (customerInfo) {
            ...
            var tmp = customerInfo.eleMeters
              .concat(customerInfo.watMeters)
              .concat(customerInfo.gasMeters)
              .concat(customerInfo.hotMeters)
            this.meterList = tmp
      ...
      this.$http.ajaxGet(
        ...
        res => {
          ...
          var infos = [
            ...
            { label: '能源类型', prop: 'typeName', typeName: meter.typeName },
    ...
    loadData() {
      ...
      if (this.dataForm.selectedPointType === 0) {
        this.tbCols = [
          { prop: 'datatime', label: '时间', width: '60' },
