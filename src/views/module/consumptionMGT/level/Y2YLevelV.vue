<template>
  ...
  >
    <el-form :inline="true" style="height:50px;">
      <el-form-item label="能源类别">
        <el-select size="mini" v-model="type" style="width:100px">
          <el-option value="0" label="综合"></el-option>
          <el-option value="88" label="电"></el-option>
          <el-option value="89" label="水"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
