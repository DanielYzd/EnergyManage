<template>
  <el-dialog custom-class="dialogcommon" :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
      ...
      <el-form-item label="上级菜单" prop="parentName">
        <el-popover ref="menuListPopover" placement="bottom-start" trigger="click">
          <el-tree :data="menuList" :props="menuListTreeProps" node-key="menuId" ref="menuListTree"
            style="width:230px;height:400px;overflow-y:scroll;" @current-change="menuListTreeCurrentChangeHandle"
