<template>
  <el-dialog custom-class="dialogcommon" title="表计更换" :close-on-click-modal="false" :visible.sync="visible">
    <el-steps :active="active" finish-status="success">
      <el-step title="设置换表信息"></el-step>
      <el-step title="补录旧表底度"></el-step>
      <el-step title="设置新表初始底度"></el-step>
    </el-steps>
    <el-form :model="dataForm" :inline="true" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="140px"
      size="small" style="padding-top:10px;">
      <div v-if="active === 0">
        ...
        <el-form-item label="表计名称" prop="pointid">
          <el-select v-model="dataForm.pointid" style="width:220px;" placeholder="请选择" @change="selectMeter">
            <el-option v-for="item in meterList" :key="item.pointid" :label="item.disc" :value="item.pointid">
            </el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="能源类型" prop="typeName">
        ...
        <el-form-item label="安装位置" prop="instLocation">
          <el-input v-model="dataForm.instLocation" placeholder="安装位置" style="width:220px;" disabled></el-input>
        </el-form-item>
        ...
        <el-form-item label="更换时间" prop="inputTime">
          <el-date-picker v-model="dataForm.changeTime" style="width: 220px;" type="datetime"
            value-format="yyyy-MM-dd HH:mm:00" format="yyyy-MM-dd HH:mm:00"></el-date-picker>
        </el-form-item>
      ...
      <div v-if="active === 1">
        <el-form-item label="数据时间" prop="operateTime">
          <el-date-picker v-model="dataForm.operateTime" style="width: 220px;" type="date"
            value-format="yyyy-MM-dd 00:00:00" format="yyyy-MM-dd 00:00:00"></el-date-picker>
      ...
      <div v-if="active === 2">
        <el-form-item label="新表初始采集时间" prop="operateTime2">
          <el-date-picker v-model="dataForm.operateTime2" style="width: 220px;" type="date"
            value-format="yyyy-MM-dd 00:00:00" format="yyyy-MM-dd 00:00:00"></el-date-picker>
        </el-form-item>
        <br />
...
export default {
  ...
  methods: {
    ...
    removeTab(targetName) {
      this[
        targetName === '1' ? 'oldMeterDataVisible' : 'newMeterDataVisible'
      ] = false
      this.activedTabName = '-1'
    },
    back() {
    ...
    initData() {
      ...
      this.dataForm.operateTime2 = tool.formatDate(
        new Date(),
        'yyyy-MM-dd 00:00:00'
      )
