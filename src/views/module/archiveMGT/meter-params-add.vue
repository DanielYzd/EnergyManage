  ...
  <el-dialog title="下发" custom-class="dialogcommon" :close-on-click-modal="false" :visible.sync="visible">
    ...
    >
      ...
      <el-form-item label="电能示值整数位个数">
        <el-input
          v-model="dataForm.integernum"
          placeholder="电能示值整数位个数"
          style="width: 200px;"
        ></el-input>
      </el-form-item>
      <el-form-item label="电能示值小数位个数">
        <el-input
          ...
          placeholder="电能示值小数位个数"
          style="width: 200px;"
        ></el-input>
      </el-form-item>
      <el-form-item label="用户大类号">
        <el-input-number
          v-model="dataForm.bigclass"
          :min="0"
          style="width: 200px;"
        ></el-input-number>
      </el-form-item>
