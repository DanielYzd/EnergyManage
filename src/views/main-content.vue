  ...
  >
    ...
    >
      ...
      <el-tab-pane
        ...
        :name="item.name"
      >
        <el-card class="content-wrap" id="ddd">
          <iframe
          ...
          <div v-else :style="activeStyle" class="maincontent">
            <keep-alive>
              <router-view v-if="item.name === mainTabsActiveName" />
            </keep-alive>
          </div>
    ...
    <!-- 主入口标签页 e -->
    <el-card v-else :body-style="siteContentViewHeight" id="ccc">
      <keep-alive>
        <router-view />
      </keep-alive>
    </el-card>
...
export default {
  ...
  computed: {
    ...
    activeStyle() {
      var height = this.documentClientHeight - 135
